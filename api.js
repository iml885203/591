...
const DatabaseStorage = require('./lib/infrastructure/persistence/DatabaseStorage');
const QueryId = require('./lib/domain/valueObjects/QueryId');
const SearchUrl = require('./lib/domain/valueObjects/SearchUrl');
const UrlNormalizer = require('./lib/domain/valueObjects/UrlNormalizer');
