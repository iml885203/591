 ...
 * Infrastructure Layer - External service integration for Discord webhooks
 * 
 * Responsibilities:
 * - Send rental notifications to Discord channels
 * - Format rental data as Discord embeds
 * - Handle Discord API rate limiting and errors
 * - Support different notification types (normal, silent, error)
 */
