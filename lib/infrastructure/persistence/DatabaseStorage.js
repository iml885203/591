 ...
 * Infrastructure Layer - PostgreSQL database implementation using Prisma ORM
 * 
 * Responsibilities:
 * - Implement data persistence for crawl results
 * - Manage database transactions and connections
 * - Provide optimized queries for performance
 * - Handle data mapping between domain models and database schema
 */

const { PrismaClient } = require('@prisma/client');
const SearchUrl = require('../../domain/valueObjects/SearchUrl');
const QueryId = require('../../domain/valueObjects/QueryId');
...
const IStorageAdapter = require('../../interfaces/IStorageAdapter');

class DatabaseStorage extends IStorageAdapter {
  constructor() {
