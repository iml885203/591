...
const swaggerDefinition = {
  ...
  servers: [
    ...
    {
      url: 'https://591-crawler-production.up.railway.app',
        ...
        properties: {
          ...
          data: {
            ...
            properties: {
              ...
              propertiesFound: {
                type: 'integer',
                description: 'Deprecated: use rentalsFound',
                deprecated: true
              },
              newProperties: {
                type: 'integer',
                description: 'Deprecated: use newRentals',
                deprecated: true
              },
              properties: {
                type: 'array',
                description: 'Deprecated: use rentals',
                deprecated: true,
                items: {
                  $ref: '#/components/schemas/Rental'
                }
