...
class Rental {
  ...
  /**
   * Check if this rental property is far from MRT
   * @param {number|null} distanceThreshold - Threshold in meters (null = no filtering)
   * @returns {boolean} True if property is far from MRT
   */
  ...
  /**
   * Get unique identifier for this property
  ...
  /**
   * Check if property should be sent as silent notification
