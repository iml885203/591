      ...
      const result = await this.prisma.$transaction(async (tx) => {
        ...
        const query = await tx.query.upsert({
          ...
          create: {
            ...
            stations: queryObj.getStations(),
            metro: queryObj.getMetro(),
            priceMin: priceRange?.min,
            priceMax: priceRange?.max,
            sections: queryObj.getSections(),
            rooms: queryObj.getRoomFilters(),
        ...
        const crawlSession = await tx.crawlSession.create({
          data: {
            ...
            filterConfig: crawlOptions.filter,
            ...
            stationsCrawled: crawlOptions.stationsCrawled || [],
