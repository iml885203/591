...
describe('multiStationCrawler', () => {
  ...
  describe('crawlMultipleStations', () => {
    ...
    it('should respect maxConcurrent limit', async () => {
      ...
      const options: CrawlOptions = { maxConcurrent: 2 };
      ...
      const trackingCrawl591 = createMockFunction<(...args: any[]) => Promise<MockRental[]>>()
        .mockImplementation(async () => {
          ...
          await new Promise<void>(resolve => setTimeout(resolve, 50)); // Simulate delay
          activeRequests--;
          return [];
        });

      const dependencies: Dependencies = { crawl591: trackingCrawl591 };
